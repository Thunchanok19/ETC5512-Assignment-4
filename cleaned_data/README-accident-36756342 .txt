...
- Methods for processing the data: The data consists of multiple tables which have been joined together using ACCIDENT_NO as a primary key. Certain variables are aggregated to reduce the risk of re-identification of individuals. The AGE_GROUP variable has been recoded into broader bands to reflect a better grouping for further analysis. Observations with missing values or unidentified values are removed from the dataset.
