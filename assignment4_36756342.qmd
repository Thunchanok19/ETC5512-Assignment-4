...
#### Dataset 1: 2021 Victoria Census Data
The dataset was downloaded from abs.gov.au website and saved in the data folder.
The data was loaded and cleaned using the following codes;

```{r}
census_data_vic <- read_csv("data/2021Census_G01_VIC_STE.csv")
```
...
census_data_vic_tidy <- census_data_vic |>
...
joined_data <- joined_data |>
  mutate(AGE_GROUP = case_when(
    ...
    AGE_GROUP %in% c('30-39', '40-49') ~ '30-49',
    AGE_GROUP == '50-59' ~ '50-59',
    AGE_GROUP == '60-64' ~ '60-69',
    AGE_GROUP %in% c('65-69', '70+') ~ '70+'
  )) |>
  mutate(AGE_GROUP = factor(AGE_GROUP, levels = c(
    '0-15', '16-21', '22-29', '30-49', '50-59', '60-69', '70+'
  )))
```
